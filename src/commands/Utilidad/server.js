...
module.exports = {
  ...
  if(server.emojis){embed.addField('Emojis', server.emojis.cache.size, true)}        
  embed.addField('Canales(Total)', server.channels.cache.size, true)
  if(server.systemChannel) {embed.addField("Canal de sistema", server.systemChannel.toString(), true)}
